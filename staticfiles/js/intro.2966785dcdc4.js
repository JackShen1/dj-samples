...
function togglePause(toggle) {
	...
	let newValue;
	if (typeof toggle === 'boolean') newValue = toggle;
	else newValue = !paused;
...
// Invisible stars need an identifier, even through they won't be rendered - physics still apply.
