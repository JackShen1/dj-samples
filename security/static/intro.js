...
function initialize() {
    ...
    startElement.addEventListener('click', addRow);
    resizeHandler();
}
...
function addRow () {
    ...
    <h2 class="frame-0">HELLO AND WELCOME</h2>
    <h2 class="frame-01">TO THE BEST</h2>
    <h2 class="frame-02">PRESENTATION EVER!</h2>
    <h2 class="frame-03">SOON YOU WILL SEE THE WORK</h2>
    <h2 class="frame-1">OF WHOLE WEEK!</h2>
    <h2 class="frame-2">WHICH I MADE </h2>
    <h2 class="frame-3">TO BLOW YOUR MIND</h2>
    <h2 class="frame-4">WITH MY PROGRAMMING SKILLS</h2>
    <h2 class="frame-6">AND AMAZING ESSAY!</h2>
    <h2 class="frame-45">SO</h2>
    <h2 class="frame-5">
    <span>ARE</span>
    <span>YOU</span>
    <span>READY?</span>
  ...
  `;
    ...
    document.getElementById('my-content').appendChild(div);

    setInterval(function () {
        document.getElementById('kave').style.visibility = "visible";
    }, 73000);
}
